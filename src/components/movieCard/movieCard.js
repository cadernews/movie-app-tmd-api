...
export default class MovieCard extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (resizeHelper !== prevProps.resizeHelper) {
      this.setState({
        trimedDescription: trimDescription(
          description,
          this.cardRef,
          this.headerRef,
          this.descriptionRef,
  ...
  render() {
    ...
    const formatedDate = date ? (
      <div className="movie_card__date">{format(new Date(date), "PP")}</div>
    ) : null;
              ...
              <div className="movie-card__info">
                <header className="movie-card__header" ref={this.headerRef}>
                  ...
                  <div className="movie-card__genres">
                    {getGenresNames(genresIds, genresList)}{" "}
                  </div>
                </header>
